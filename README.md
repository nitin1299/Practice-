...
- ## Visualisations Included
  ...
  2. Daily Return Distribution Histograms
  3. Return Correlation Heatmap
  4. Cumulative Returns (Growth of $1)
  5. 30-Day Rolling Annualised Volatility
  ...
  7. - **Python**
     ...
     - **yfinance** -- stock data API
      ...
      - ## How to Run
        ...
        2. Install the required libraries: `pip install pandas numpy matplotlib seaborn yfinance`
        3. Run the script: `python Stock_Data_Fetching_and_EDA.py`
